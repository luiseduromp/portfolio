  ...
  switch (cover.type) {
    case "logo":
      return (
        <div
          className={cn(
            "h-50 bg-linear-to-br from-white to-neutral-300 flex items-center justify-center w-full py-8 ",
            cover.background,
          )}
        >
          <Image
...
export const ProjectCard = ({
  ...
  return (
    <div className={cn(className)} {...props}>
      <a
        className={cn(
          "inline-block dark:bg-neutral-900 rounded-xl mb-4 overflow-hidden w-[360px] cursor-pointer border border-neutral-800 relative group hover:scale-105 transition-all duration-200",
        )}
      >
        ...
        <div className="px-6 py-3 flex flex-col justify-center h-36">
          ...
          <p className="text-3xl font-bold text-neutral-950 dark:text-neutral-50 mb-1">
            {project.name}
          </p>
        </div>
        ...
        <div className="px-6 py-4 border-t border-teal-500 border-dashed flex justify-between gap-2 items-center">
          ...
          <p className="text-neutral-300 dark:text-neutral-300 font-bold">
            {project.year}
          </p>
        </div>
      </a>
