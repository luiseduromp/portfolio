...
export const IAGLogo = (props: SVGProps<SVGSVGElement>) => {
    return (
        <svg id="b" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 319.68 133.9" {...props}>
            <g id="c">
                <path fill="#777776" d="M66.54,109.32l-12.02-43.94-.22-.55h12.12c1.46-.02,2.87.52,3.94,1.51,0,0,29.09,31.3,36.9,37.48,6.15,4.98,10.15,5.32,13.13,5.32h4.89L88.93,24.3h-22.63L30.2,109.32h36.35Z" />
                <rect fill="#777776" y="24.3" width="23.62" height="84.99" />
                <path fill="#777776" d="M119.92,67.23v-.25c0-24.66,19.25-44,45.48-44,12.59-.45,24.87,3.96,34.32,12.3l-13.78,16.6c-5.55-5.15-12.85-7.99-20.42-7.96-12.3,0-21.52,10.27-21.52,23.22v.25c-.6,12.33,8.91,22.81,21.24,23.41.58.03,1.15.03,1.73.02,4.76.21,9.47-1.01,13.53-3.51v-10.18h-16.79v-17.28h38.9v38.07c-10.33,8.51-23.33,13.12-36.71,13.04-26.35,0-46.12-18.11-46.12-43.76" />
                <circle fill="#ea510d" cx="298.18" cy="66.95" r="21.5" />
                <circle fill="#ea510d" cx="265.69" cy="35.15" r="16" />
                <circle fill="#ea510d" cx="265.69" cy="99.36" r="16" />
                <circle fill="#ea510d" cx="241.15" cy="11" r="11" />
                <circle fill="#ea510d" cx="241.15" cy="122.9" r="11" />
            </g>
        </svg>
    )
}

export const IngelinLogo = (props: SVGProps<SVGSVGElement>) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 276.27 200" {...props}>
            <defs>
