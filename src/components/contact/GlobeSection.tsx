...
export const GlobeSection = () => {
  ...
  return (
    <section>
      <div
        ref={containerRef}
        className="relative overflow-hidden h-100 md:h-120"
      >
        ...
        <div className="absolute inset-0 flex justify-center items-center gap-4 z-30">
          ...
          <div>
            ...
            <h4 className="location-city font-bold text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl mb-2 lg:mb-3">
              Barcelona
            </h4>
