...
export const LogoAnimated = ({ variant, ...props }: { variant: 'light' | 'dark' } & React.HTMLAttributes<HTMLDivElement>) => {
    const col = {
    ...
    return (
        <div ref={containerRef} className={cn("w-full bg-black h-[400vh] relative")} {...props}>
            <div className="intro absolute left-0 top-0 right-0 h-screen flex justify-center items-center pointer-events-none">
                <h3 className="uppercase text-3xl font-mono perspective-normal">[ Scroll Down ]</h3>
            </div>
            
            <svg id="b" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1001 999.31" className="w-full md:w-150 mx-auto pt-20 opacity-0">
                <g id="c">
                    <path className="f char" fill={col[variant].f} opacity={0} d="M193.96,84.21l52.84,72.6h597.13v685.69h-59.97l52.84,72.6h60.39c10.64,0,19.26-8.61,19.26-19.23V103.44c0-10.62-8.62-19.23-19.26-19.23H193.96Z"/>
                    <path className="l char" fill={col[variant].l} opacity={0} d="M84.35,103.44v792.43c0,10.62,8.62,19.23,19.26,19.23h566.07s-52.84-72.6-52.84-72.6H157.07V157.04l-53-72.83h-.46c-10.64,0-19.26,8.61-19.26,19.23Z"/>
                    <path className="r char" fill={col[variant].r} opacity={0} d="M532.19,548.95c65.71-20.06,114.04-81.43,114.04-153.19,0-87.84-72.41-160.13-160.4-160.13h-194.12v517.45h72.72v-444.85h121.06c.23,0,.46,0,.69,0,47.45,0,86.5,38.98,86.5,86.35s-38.71,86.05-85.95,86.35h-93.94l315.98,434.17h89.89l-266.47-366.15Z"/>
                    ...
                    <path className="bor" fill="none" strokeWidth={2} stroke={col[variant].border} d="M84.35,103.44v792.43c0,10.62,8.62,19.23,19.26,19.23h566.07s-52.84-72.6-52.84-72.6H157.07V157.04l-53-72.83h-.46c-10.64,0-19.26,8.61-19.26,19.23Z"/>
                    <path className="bor" fill="none" strokeWidth={2} stroke={col[variant].border} d="M193.96,84.21l52.84,72.6h597.13v685.69h-59.97l52.84,72.6h60.39c10.64,0,19.26-8.61,19.26-19.23V103.44c0-10.62-8.62-19.23-19.26-19.23H193.96Z"/>
                    <path className="bor" fill="none" strokeWidth={2} stroke={col[variant].border} d="M532.19,548.95c65.71-20.06,114.04-81.43,114.04-153.19,0-87.84-72.41-160.13-160.4-160.13h-194.12v517.45h72.72v-444.85h121.06c.23,0,.46,0,.69,0,47.45,0,86.5,38.98,86.5,86.35s-38.71,86.05-85.95,86.35h-93.94l315.98,434.17h89.89l-266.47-366.15Z"/>
             ...
             <div id="hero" className="absolute left-0 top-0 right-0 h-screen flex justify-center items-center bg-black/50 perspective-normal opacity-0 translate-y-20 scale-90">
                <Container id="intro" className="font-main relative">
                    <div className="mb-12">
                    <h2 className="text-8xl font-bold uppercase">
                        Quality and Design <br/>
                    </h2>
                    <h2 className="text-6xl font-bold uppercase text-neutral-400">in Web Applications</h2>
                    </div>
                    <h1 className="text-4xl mb-3">This is <span>Luis Romero</span></h1>
                    <p className="font-monospace text-4xl text-teal-400">Fullstack Developer and Engineer</p>
                    <div className="flex py-12 gap-4">
                    <GlowButton href="/projects" className="uppercase">Projects</GlowButton>
                    <GlowButton href="/contact" className="uppercase">Contact</GlowButton>
                    </div>
