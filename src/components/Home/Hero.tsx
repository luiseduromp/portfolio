...
export const Hero = ({ variant, ...props }: { variant: 'light' | 'dark' } & React.HTMLAttributes<HTMLDivElement>) => {
    ...
    return (
        <section ref={containerRef} className={cn("w-full bg-black h-screen relative overflow-hidden")} {...props}>
            <div id="intro" className="absolute left-0 top-0 right-0 h-screen flex justify-center items-center pointer-events-none perspective-normal">
                <h3 className="text-center lg:text-2xl">Welcome to <span className="font-bold">Luis Romero&apos;s </span> Portfolio</h3>
            </div>
            
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1001 999.31" className="w-full md:w-150 mx-auto pt-20 opacity-0">
                <g>
            ...
            <header id="hero" className="absolute left-0 top-0 right-0 h-screen bg-black/50 perspective-normal opacity-0 scale-30">
