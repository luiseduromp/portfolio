...
export const NavButton: React.FC<LinkProps & React.HTMLProps<HTMLAnchorElement>> = ({children, href}) => {
    return (
        <Link href={href} className="lg:text-lg border border-teal-200 rounded-full px-6 py-3 flex items-center group text-teal-200 hover:bg-teal-300 hover:border-teal-300 hover:text-black transition-colors duration-200">
            {children}
