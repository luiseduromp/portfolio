          ...
          >
            <Container>
              <div className="flex gap-4 items-center mb-6">
                <div className="size-16 lg:size-22 font-mono bg-neutral-900 text-teal-200 flex items-center justify-center text-3xl lg:text-3xl">
                  0{index + 1}
                </div>
                ...
                <div className="md:flex-1">
                  ...
                  <div className="flex flex-wrap">
                    {category.stack.map((tec) => (
                      <span
                        key={tec}
                        className="text-xl font-semibold text-neutral-300 hover:text-teal-300 lg:text-2xl border-b border-neutral-700 hover:border-teal-200 py-2 pe-2"
                      >
                        {tec}
                      </span>
                    ))}
