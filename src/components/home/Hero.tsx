...
export const Hero = ({
  ...
  useGSAP(() => {
    ...
    const split = SplitText.create(intro.children, {
      type: "lines",
      mask: "lines",
    });
  ...
  return (
    <section
      ref={containerRef}
      className={cn("w-full bg-black h-screen relative overflow-hidden")}
      {...props}
    >
      <div
        id="intro"
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <svg
          ...
          className="w-full md:w-150 mx-auto opacity-0"
        >
          <g>
            <path
              className="f char"
      ...
      <header
        id="hero"
        className="absolute left-0 top-0 right-0 h-screen perspective-normal opacity-0 scale-20"
      >
        <Container
          id="intro"
          className="relative flex flex-col h-full gap-12 my-auto justify-center"
        >
